...
## Purpose
Defines the structure and contract of the per-layer data file that powers the cake layer info popup. The data file is a separate, preloaded JS file that exposes a global array consumed by `palermo-cake.js`.
